    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('protected_pos_url', models.CharField(blank=True, default='/m/sales/pos/', help_text='URL that requires an open cash session.', max_length=200, verbose_name='Protected POS URL')),
            ],
            options={
